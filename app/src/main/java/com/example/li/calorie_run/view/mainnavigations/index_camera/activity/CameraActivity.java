package com.example.li.calorie_run.view.mainnavigations.index_camera.activity;
...
import com.example.li.calorie_run.presenter.Impl.EarlyClickPresenterImpl;
...
import com.example.li.calorie_run.view.mainnavigations.index_camera.camera.CameraInterface;
import com.example.li.calorie_run.view.mainnavigations.index_camera.camera.preview.CameraSurfaceView;
import com.example.li.calorie_run.view.mainnavigations.index_camera.mode.GoogleFaceDetect;
import com.example.li.calorie_run.view.mainnavigations.index_camera.ui.FaceView;
import com.example.li.calorie_run.view.mainnavigations.index_camera.util.DisplayUtil;
import com.example.li.calorie_run.view.mainnavigations.index_camera.util.EventUtil;

public class CameraActivity extends Activity implements AccountView {
	...
	private IEarlyClickPresenter presenter;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);

		presenter = new EarlyClickPresenterImpl(this);
	...
	private class BtnListeners implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.btn_shutter:
				takePicture();
				presenter.earlyClick(ConstantValue.USER_ID);
				break;
...
//		startGoogleFaceDetect();
	...
	public void navigateToHome(String value) {
		this.value = value;
		Toast.makeText(CameraActivity.this,value,Toast.LENGTH_SHORT).show();
